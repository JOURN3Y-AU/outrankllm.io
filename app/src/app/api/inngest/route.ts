...
import { processScan, processScanFailureHandler } from "@/inngest/functions/process-scan"
...
export const { GET, POST, PUT } = serve({
  client: inngest,
  functions: [processScan, processScanFailureHandler, hourlyScanDispatcher, enrichSubscriber, processHiringBrandScan, hiringBrandWeeklyDispatcher, scanHealthMonitor],
})
