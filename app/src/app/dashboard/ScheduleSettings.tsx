...
function Dropdown({ value, onChange, options, icon, label, grouped, groups }: DropdownProps) {
...
export function ScheduleSettings({
  ...
  return (
    ...
    >
      <h2
        className="font-mono text-sm text-[var(--text-dim)] uppercase tracking-wider"
      ...
      <p className="text-sm text-[var(--text-mid)]" style={{ marginBottom: '20px' }}>
        Your AI visibility report refreshes automatically every week.
      </p>

      <div className="grid gap-4 md:grid-cols-3" style={{ marginBottom: '20px' }}>
        {/* Day selector */}
        <Dropdown
          value={day}
